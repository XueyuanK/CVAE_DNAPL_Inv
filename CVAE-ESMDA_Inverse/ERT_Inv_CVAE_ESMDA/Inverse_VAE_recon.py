...
s_tem=s[:,:,0]
savemat('./s_tem0.mat', {'s_tem':s_tem}) # save s for each step
...
savemat('results_esmda.mat',{'s':s,'KS_final_ens':KS_final_ens,'sim_obs':sim_obs,'KS_mean':KS_mean}) # sim_obs for the last step
